...
Network access is limited to your own Ollama instance, `localhost:11434` by
default, and only when you request the optional AI briefing. Extraction,
calendar sync and conflict detection reach no network at all. No Anthropic or
other cloud endpoint appears anywhere in the codebase.
