...
//!
//! LifePlanner ships for macOS, Windows and Linux, and each has its own backend,
...
const SERVICE: &str = "lp-keychain-test";
const CHILD_ENV: &str = "LP_KEYCHAIN_TEST_CHILD";
