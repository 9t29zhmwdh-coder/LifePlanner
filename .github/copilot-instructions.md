# Copilot Instructions for LifePlanner

LifePlanner is an offline-first AI life planner built with Rust, Tauri and local AI via Ollama. It recognizes appointments, tasks, projects and deadlines from emails, PDFs and notes, links them intelligently and helps plan the day without a single byte leaving the device.
